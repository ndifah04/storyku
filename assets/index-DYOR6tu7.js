var ye=Object.defineProperty;var q=r=>{throw TypeError(r)};var ve=(r,e,t)=>e in r?ye(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var Y=(r,e,t)=>ve(r,typeof e!="symbol"?e+"":e,t),N=(r,e,t)=>e.has(r)||q("Cannot "+t);var d=(r,e,t)=>(N(r,e,"read from private field"),t?t.call(r):e.get(r)),b=(r,e,t)=>e.has(r)?q("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(r):e.set(r,t),k=(r,e,t,i)=>(N(r,e,"write to private field"),i?i.call(r,t):e.set(r,t),t),u=(r,e,t)=>(N(r,e,"access private method"),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&i(n)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();const m={BASE_URL:"https://story-api.dicoding.dev/v1",VAPID_PUBLIC_KEY:"BCCs2eonMI-6H2ctvFaWg-UYdDv387Vno_bzUzALpB442r2lCnsHmtrx8biyPi_E-1fSGABK_Qs_GlvPoJJqxbk",DATABASE_NAME:"dicoding-story-database",DATABASE_VERSION:2,OBJECT_STORE_NAME:"stories"},B={async register({name:r,email:e,password:t}){return await(await fetch(`${m.BASE_URL}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:r,email:e,password:t})})).json()},async login({email:r,password:e}){return await(await fetch(`${m.BASE_URL}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:r,password:e})})).json()},async getAllStories({token:r,page:e=1,size:t=10,location:i=1}){return await fetch(`${m.BASE_URL}/stories?page=${e}&size=${t}&location=${i}`,{headers:{Authorization:`Bearer ${r}`}})},async getStoryDetail({token:r,id:e}){return await(await fetch(`${m.BASE_URL}/stories/${e}`,{headers:{Authorization:`Bearer ${r}`}})).json()},async addNewStory({token:r,description:e,photo:t,lat:i,lon:s}){const a=new FormData;return a.append("description",e),a.append("photo",t),i!==void 0&&s!==void 0&&(a.append("lat",i),a.append("lon",s)),await(await fetch(`${m.BASE_URL}/stories`,{method:"POST",headers:{Authorization:`Bearer ${r}`},body:a})).json()},async subscribeNotification({token:r,subscription:e}){return await fetch(`${m.BASE_URL}/notifications/subscribe`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify(e)})},async unsubscribeNotification({token:r,endpoint:e}){return await fetch(`${m.BASE_URL}/notifications/subscribe`,{method:"DELETE",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({endpoint:e})})}},O="dicoding_story_auth",g={setAuth({userId:r,name:e,token:t}){localStorage.setItem(O,JSON.stringify({userId:r,name:e,token:t}))},getAuth(){return JSON.parse(localStorage.getItem(O))||null},destroyAuth(){localStorage.removeItem(O)},isLoggedIn(){return!!this.getAuth()}};function K(r,e="en-US",t={}){return new Date(r).toLocaleDateString(e,{year:"numeric",month:"long",day:"numeric",...t})}function be(r){const e="=".repeat((4-r.length%4)%4),t=(r+e).replace(/\-/g,"+").replace(/_/g,"/"),i=window.atob(t);return Uint8Array.from([...i].map(s=>s.charCodeAt(0)))}class we{constructor(){this.stories=[],this.map=null,this.markers=[],this.subscribe=!1}async render(){return`
    ...
    `).join("")}truncateText(e,t){return e.length<=t?e:e.substring(0,t)+"..."}}class Ee{constructor(){this.presenter=new we}async render(){return this.presenter.render()}async afterRender(){await this.presenter.afterRender()}}const G=(r,e)=>e.some(t=>r instanceof t);let X,Q;function Se(){return X||(X=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ke(){return Q||(Q=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const F=new WeakMap,U=new WeakMap,$=new WeakMap;function Le(r){const e=new Promise((t,i)=>{const s=()=>{r.removeEventListener("success",a),r.removeEventListener("error",n)},a=()=>{t(I(r.result)),s()},n=()=>{i(r.error),s()};r.addEventListener("success",a),r.addEventListener("error",n)});return $.set(e,r),e}function Ie(r){if(F.has(r))return;const e=new Promise((t,i)=>{const s=()=>{r.removeEventListener("complete",a),r.removeEventListener("error",n),r.removeEventListener("abort",n)},a=()=>{t(),s()},n=()=>{i(r.error||new DOMException("AbortError","AbortError")),s()};r.addEventListener("complete",a),r.addEventListener("error",n),r.addEventListener("abort",n)});F.set(r,e)}let H={get(r,e,t){if(r instanceof IDBTransaction){if(e==="done")return F.get(r);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return I(r[e])},set(r,e,t){return r[e]=t,!0},has(r,e){return r instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in r}};function se(r){H=r(H)}function Be(r){return ke().includes(r)?function(...e){return r.apply(z(this),e),I(this.request)}:function(...e){return I(r.apply(z(this),e))}}function Ae(r){return typeof r=="function"?Be(r):(r instanceof IDBTransaction&&Ie(r),G(r,Se())?new Proxy(r,H):r)}function I(r){if(r instanceof IDBRequest)return Le(r);if(U.has(r))return U.get(r);const e=Ae(r);return e!==r&&(U.set(r,e),$.set(e,r)),e}const z=r=>$.get(r);function Me(r,e,{blocked:t,upgrade:i,blocking:s,terminated:a}={}){const n=indexedDB.open(r,e),o=I(n);return i&&n.addEventListener("upgradeneeded",l=>{i(I(n.result),l.oldVersion,l.newVersion,I(n.transaction),l)}),t&&n.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),o.then(l=>{a&&l.addEventListener("close",()=>a()),s&&l.addEventListener("versionchange",h=>s(h.oldVersion,h.newVersion,h))}).catch(()=>{}),o}const Pe=["get","getKey","getAll","getAllKeys","count"],Te=["put","add","delete","clear"],_=new Map;function Z(r,e){if(!(r instanceof IDBDatabase&&!(e in r)&&typeof e=="string"))return;if(_.get(e))return _.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,s=Te.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(s||Pe.includes(t)))return;const a=async function(n,...o){const l=this.transaction(n,s?"readwrite":"readonly");let h=l.store;return i&&(h=h.index(o.shift())),(await Promise.all([h[t](...o),s&&l.done]))[0]};return _.set(e,a),a}se(r=>({...r,get:(e,t,i)=>Z(e,t)||r.get(e,t,i),has:(e,t)=>!!Z(e,t)||r.has(e,t)}));const Ce=["continue","continuePrimaryKey","advance"],ee={},V=new WeakMap,ae=new WeakMap,De={get(r,e){if(!Ce.includes(e))return r[e];let t=ee[e];return t||(t=ee[e]=function(...i){V.set(this,ae.get(this)[e](...i))}),t}};async function*xe(...r){let e=this;if(e instanceof IDBCursor||(e=await e.openCursor(...r)),!e)return;e=e;const t=new Proxy(e,De);for(ae.set(t,e),$.set(t,z(e));e;)yield t,e=await(V.get(t)||e.continue()),V.delete(t)}function te(r,e){return e===Symbol.asyncIterator&&G(r,[IDBIndex,IDBObjectStore,IDBCursor])||e==="iterate"&&G(r,[IDBIndex,IDBObjectStore])}se(r=>({...r,get(e,t,i){return te(e,t)?xe:r.get(e,t,i)},has(e,t){return te(e,t)||r.has(e,t)}}));const D={async createDB(){this.db=await Me(m.DATABASE_NAME,m.DATABASE_VERSION,{upgrade(r,e,t){console.log(`Upgrading database from version ${e} to ${t}`),r.objectStoreNames.contains(m.OBJECT_STORE_NAME)&&r.deleteObjectStore(m.OBJECT_STORE_NAME),r.createObjectStore(m.OBJECT_STORE_NAME,{keyPath:["id","userId"]}).createIndex("userId","userId")}})},async getAllFavorites(){const r=g.getAuth();return r==null?[]:(await this.db.getAllFromIndex(m.OBJECT_STORE_NAME,"userId",r.userId)).filter(async t=>t.name==null||t.createdAt==null||t.description==null?(await this.deleteFavorite(t.id),!1):!0)},async addFavorite(r){const e=g.getAuth();e!=null&&await this.db.add(m.OBJECT_STORE_NAME,{id:r.id,userId:e.userId,...r})},async deleteFavorite(r){const e=g.getAuth();e!=null&&await this.db.delete(m.OBJECT_STORE_NAME,[r,e.userId])},async isFavorite(r){const e=g.getAuth();if(e==null)return;const t=await this.db.get(m.OBJECT_STORE_NAME,[r,e.userId]);return console.log(t),t}};class Re{constructor({view:e,params:t}){this.view=e,this.params=t,this.story=null}async loadStoryDetails(){const e=g.getAuth();if(!e)throw new Error("Autentikasi diperlukan");const t=await B.getStoryDetail({token:e.token,id:this.params.id});if(t.error)throw new Error(t.message);this.story=t.story;const i=await D.isFavorite(this.params.id);return{story:this.story,favorite:i}}async addFavorite(){await D.addFavorite(this.story)}async removeFavorite(){await D.deleteFavorite(this.params.id)}formatDescription(e){return e.split(`
`).map(t=>t.trim()?`<p>${t}</p>`:"").join("")}}var A,j,ne;class $e{constructor({params:e}){b(this,A);this.id=e.id,this.presenter=new Re({view:this,params:e}),this.story=null,this.map=null,this.favoriteButton=null,this.favorite=!1}async render(){return`
      <section class="container page-transition">
    ...
    `,this.loginButton.disabled=!1}clearErrors(){this.emailError.textContent="",this.passwordError.textContent="",this.loginStatus.innerHTML=""}}class _e{constructor({onSuccess:e,onError:t}){this.onSuccess=e,this.onError=t}validate({name:e,email:t,password:i,confirmPassword:s},a){const{showNameError:n,showEmailError:o,showPasswordError:l,showConfirmPasswordError:h}=a;let y=!0;return e||(n("Nama tidak boleh kosong"),y=!1),t?this.isValidEmail(t)||(o("Email tidak valid"),y=!1):(o("Email tidak boleh kosong"),y=!1),(!i||i.length<8)&&(l("Password minimal 8 karakter"),y=!1),i!==s&&(h("Password tidak cocok"),y=!1),y}isValidEmail(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}async register({name:e,email:t,password:i}){try{const s=await B.register({name:e,email:t,password:i});if(s.error)throw new Error(s.message||"Registrasi gagal");this.onSuccess()}catch(s){console.error("RegisterPresenter Error:",s),this.onError(s.message||"Terjadi kesalahan saat registrasi.")}}}class Ge{constructor(){this.presenter=new _e({onSuccess:this.showSuccess.bind(this),onError:this.showError.bind(this)})}async render(){return`
      <section class="container page-transition">
    ...
    `).join("")}truncateText(e,t){return e.length<=t?e:e.substring(0,t)+"..."}}class Ve{constructor(){this.presenter=new ze}async render(){return this.presenter.render()}async afterRender(){await this.presenter.afterRender()}}const oe={"/":{page:Ee,needAuth:!0},"/detail/:id":{page:$e,needAuth:!0},"/add":{page:Ne,needAuth:!0},"/login":{page:Ue,needAuth:!1},"/register":{page:Ge,needAuth:!1},"/about":{page:He,needAuth:!1},"/favorites":{page:Ve,needAuth:!0}};function je(r){const e=oe[r];return e?e.needAuth&&!g.isLoggedIn()?"/login":r==="/login"&&g.isLoggedIn()||r==="/register"&&g.isLoggedIn()?"/":r:null}function ce(r){const e=r.split("/");return{resource:e[1]||null,id:e[2]||null}}function We(r){let e="";return r.resource&&(e=e.concat(`/${r.resource}`)),r.id&&(e=e.concat("/:id")),e||"/"}function le(){return location.hash.replace("#","")||"/"}function Je(){const r=le(),e=ce(r);return We(e)}function Ke(){const r=le();return ce(r)}const qe="modulepreload",Ye=function(r){return"/storyku/"+r},re={},Xe=function(e,t,i){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),o=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));s=Promise.allSettled(t.map(l=>{if(l=Ye(l),l in re)return;re[l]=!0;const h=l.endsWith(".css"),y=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${y}`))return;const v=document.createElement("link");if(v.rel=h?"stylesheet":qe,h||(v.as="script"),v.crossOrigin="",v.href=l,o&&v.setAttribute("nonce",o),document.head.appendChild(v),h)return new Promise((p,x)=>{v.addEventListener("load",p),v.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${l}`)))})}))}function a(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return s.then(n=>{for(const o of n||[])o.status==="rejected"&&a(o.reason);return e().catch(a)})};function Qe(r={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:i,onRegistered:s,onRegisteredSW:a,onRegisterError:n}=r;let o,l,h;const y=async(p=!0)=>{await l,h==null||h()};async function v(){if("serviceWorker"in navigator){if(o=await Xe(async()=>{const{Workbox:p}=await import("./workbox-window.prod.es5-B9K5rw8f.js");return{Workbox:p}},[]).then(({Workbox:p})=>new p("/storyku/sw.js",{scope:"/storyku/",type:"classic"})).catch(p=>{n==null||n(p)}),!o)return;h=()=>{o==null||o.messageSkipWaiting()};{let p=!1;const x=()=>{p=!0,o==null||o.addEventListener("controlling",M=>{M.isUpdate&&window.location.reload()}),t==null||t()};o.addEventListener("installed",M=>{typeof M.isUpdate>"u"?typeof M.isExternal<"u"&&M.isExternal?x():!p&&(i==null||i()):M.isUpdate||i==null||i()}),o.addEventListener("waiting",x)}o.register({immediate:e}).then(p=>{a?a("/storyku/sw.js",p):s==null||s(p)}).catch(p=>{n==null||n(p)})}}return l=v(),y}const ie={show(){console.log("Loding Indicator"),document.getElementById("loading-overlay").style.display="flex"},hide(){document.getElementById("loading-overlay").style.display="none"}};var w,P,E,S,f,T,c,de,ue,he,R,W,C,pe,J,me,ge,fe;class Ze{constructor({navigationDrawer:e,drawerButton:t,content:i,authNavItem:s,notifSubsItem:a,favoritesItem:n}){b(this,c);b(this,w);b(this,P);b(this,E);b(this,S);b(this,f);b(this,T);Y(this,"notificationPermission",!1);this._notificationHandler=this._notificationHandler.bind(this),k(this,w,i),k(this,P,t),k(this,E,e),k(this,S,s),k(this,f,a),k(this,T,n),u(this,c,he).call(this),u(this,c,ue).call(this),u(this,c,R).call(this)}async _notificationHandler(){ie.show(),this.subscribe?(await u(this,c,ge).call(this),this.subscribe=!1):await u(this,c,me).call(this),console.log("Halo"),ie.hide(),u(this,c,J).call(this)}async renderPage(){const e=Je(),t=Ke(),i=je(e);if(i!==e){window.location.hash=i;return}const s=oe[e];if(!s){d(this,w).innerHTML='<div class="container"><h2>404 - Halaman Tidak Ditemukan</h2></div>';return}try{document.startViewTransition?await document.startViewTransition(async()=>{d(this,w).innerHTML=await new s.page({params:t}).render()}).ready:d(this,w).innerHTML=await new s.page({params:t}).render(),await new s.page({params:t}).afterRender(),u(this,c,R).call(this),u(this,c,fe).call(this)}catch(a){console.error("Kesalahan saat merender halaman:",a),d(this,w).innerHTML=`
        <div class="container">
          <h2>Terjadi kesalahan</h2>
          <p>${a.message}</p>
        </div>
      `}}}w=new WeakMap,P=new WeakMap,E=new WeakMap,S=new WeakMap,f=new WeakMap,T=new WeakMap,c=new WeakSet,de=async function(){if(!navigator.serviceWorker){console.error("Service Worker tidak berfungsi");return}console.log("Mendaftarkan Service Worker..."),Qe({onOfflineReady(){console.log("Bisa Offline.")},onNeedRefresh(){console.log("Bisa Update Versi.")},onRegistered:e=>{console.log("Service Worker terdaftar:",e),u(this,c,pe).call(this)},onRegisterError(e){console.error("Service Worker gagal terdaftar:",e)}})},ue=function(){d(this,P).addEventListener("click",()=>{d(this,E).classList.toggle("open")}),document.body.addEventListener("click",e=>{!d(this,E).contains(e.target)&&!d(this,P).contains(e.target)&&d(this,E).classList.remove("open"),d(this,E).querySelectorAll("a").forEach(t=>{t.contains(e.target)&&d(this,E).classList.remove("open")})})},he=async function(){await D.createDB(),console.log("Indexed DB Sudah Siap")},R=function(){g.isLoggedIn()?(u(this,c,de).call(this),u(this,c,W).call(this,!0),d(this,S).textContent="Logout",d(this,S).href="#/logout",d(this,S).addEventListener("click",e=>{e.preventDefault(),g.destroyAuth(),window.location.hash="#/login",u(this,c,R).call(this)})):(d(this,S).textContent="Login",d(this,S).href="#/login",u(this,c,C).call(this,!1),u(this,c,W).call(this,!1))},W=function(e){if(!e){d(this,T).parentElement.style.display="none";return}d(this,T).parentElement.style.display="block"},C=function(e){if(!e){console.log(d(this,f).parentElement),d(this,f).parentElement.style.display="none";return}d(this,f).parentElement.style.display="block"},pe=async function(){var t,i,s;if(!("Notification"in window)){console.error("Browser tidak mendukung Notification API"),u(this,c,C).call(this,!1);return}if(this.registrationNotif=await navigator.serviceWorker.getRegistration(),!((t=this.registrationNotif)!=null&&t.pushManager)){u(this,c,C).call(this,!1);return}await((s=(i=this.registrationNotif)==null?void 0:i.pushManager)==null?void 0:s.getSubscription())&&(this.subscribe=!0),u(this,c,J).call(this),d(this,f).removeEventListener("click",this._notificationHandler),d(this,f).addEventListener("click",this._notificationHandler)},J=function(){console.log("Notification Navigator"),u(this,c,C).call(this,!0),this.subscribe?d(this,f).textContent="Batalkan Berlangganan Notifikasi":d(this,f).textContent="Berlangganan Notifikasi"},me=async function(){const e=await Notification.requestPermission();if(e==="denied"){console.log("Izin notification ditolak.");return}if(e==="default"){console.log("Izin notification ditutup atau diabaikan.");return}console.log("Izin notification diterima"),this.notificationPermission=!0;const t=g.getAuth();if(!t||this.subscribe)return;const i=await this.registrationNotif.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:be(m.VAPID_PUBLIC_KEY)}),{endpoint:s,keys:a}=i.toJSON(),n={endpoint:s,keys:{auth:a.auth,p256dh:a.p256dh}};try{if(!(await B.subscribeNotification({token:t.token,subscription:n})).ok)throw new Error("Gagal berlangganan notifikasi");console.log("Akhir"),alert("Berhasil berlangganan notifikasi"),this.subscribe=!0}catch(o){console.log(o),alert("Gagal subscribe notification"),await i.unsubscribe(),this.subscribe=!1}},ge=async function(){if(console.log("Unsubscribe Notification"),console.log(this.subscribe),!this.subscribe)return;const e=g.getAuth();if(!e)return;const t=await this.registrationNotif.pushManager.getSubscription();if(!t)return;const{endpoint:i}=t.toJSON();try{const s=await B.unsubscribeNotification({token:e.token,endpoint:i}),a=await s.json();if(!s.ok)throw console.log(a),new Error("Gagal membatalkan langganan notifikasi");alert("Berhasil membatalkan langganan notifikasi"),t.unsubscribe()}catch(s){console.log(s),alert("Gagal unsubscribe notification")}},fe=function(){d(this,w).querySelectorAll(".animate-in").forEach((t,i)=>{const s=t.animate([{transform:"translateY(20px)",opacity:0},{transform:"translateY(0)",opacity:1}],{duration:500,delay:100*i,easing:"ease-out",fill:"forwards"});s.onfinish=()=>{t.classList.remove("animate-in")}})};document.addEventListener("DOMContentLoaded",async()=>{const r=new Ze({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer"),authNavItem:document.getElementById("auth-nav-item"),notifSubsItem:document.getElementById("notif-nav-item"),favoritesItem:document.getElementById("fav-nav-item")});await r.renderPage(),window.addEventListener("hashchange",async()=>{await r.renderPage()})});
